            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1">
                        <span className="text-orange-500 font-bold tracking-wider uppercase text-sm mb-2 block">Differentiators</span>
                        <h2 className="font-display font-bold text-4xl md:text-5xl text-blue-900 leading-tight mb-6">
                        ...
                        <ul className="space-y-4">
                            {reasons.map((reason, index) => (
                                <motion.li
                                    ...
                                    className="flex items-center gap-3 text-blue-700 font-medium text-lg"
                                >
                    ...
                    >
                        ...
                        {/* Floating badge */}
                        <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl z-20 border border-blue-100">
                            <div className="text-4xl font-black text-orange-600 mb-1">20+</div>
                            <div className="text-blue-600 font-medium leading-tight">Years of<br />Experience</div>
                        </div>
                    </motion.div>
                </div>
            </div>
